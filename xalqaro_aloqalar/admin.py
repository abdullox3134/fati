...
from xalqaro_aloqalar.models import Tadqiqot, Kelganlar, xamkor_loyihalar_data
...
class Xamkor_loihalarAdmin(admin.ModelAdmin):
    list_display = ('title', 'status', 'created_at', 'updated_at', 'order',)
    search_fields = ('title',)
    fields = ['title_uz', 'title_en', 'content_uz', 'content_en', 'img_file', 'xamkor_loiha', 'status',
              'order',]


@admin.register(xamkor_loyihalar_data)
class Xamkor_loihalarAdmin(admin.ModelAdmin):
    list_display = ('title', 'status', 'created_at', 'updated_at', 'order',)
    search_fields = ('title',)
    fields = ['title_uz', 'title_en', 'content_uz', 'content_en', 'isCompleted', 'status',
              'order',]
