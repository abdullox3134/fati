...
class Institut_tarixiSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'title_uz', 'title_ru', 'title_en', 'content_uz', 'content_ru', 'content_en', 'subcontent_uz', 'subcontent_en', 'subcontent_ru', 'file', 'base_file', 'status', 'order', 'created_at',
                  'updated_at',)
...
class KaruselSerializer(serializers.ModelSerializer):
    class Meta:
        model = Karusel
        fields = ('id', 'title_uz', 'title_ru', 'title_en', 'content_uz', 'content_ru', 'content_en', 'file', 'status', 'link', 'order', 'created_at', 'updated_at',)


class RahbariyatSerializer(serializers.ModelSerializer):
    class Meta:
        model = Rahbariyat
        fields = ('id', 'title_uz', 'title_ru', 'title_en', 'position', 'degree', 'contact', 'days', 'image', 'status', 'order', 'created_at',
                  'updated_at',)
...
class YangiliklarSerializer(serializers.ModelSerializer):
    class Meta:
        model = Yangiliklar
        fields = ('id', 'title_uz', 'title_ru', 'title_en', 'content_uz', 'content_ru', 'content_en', 'subcontent_uz', 'subcontent_ru', 'subcontent_en', 'file', 'status', 'order', 'created_at', 'updated_at',)


class HavolalarSerializer(serializers.ModelSerializer):
    class Meta:
        model = Havolalar
        fields = ('id', 'title_uz', 'title_ru', 'title_en', 'file', 'link', 'status', 'order', 'created_at', 'updated_at',)
