...
class Ilmiy_kengash_majlisSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'title', 'content', 'subcontent', 'file', 'date', 'status', 'order', 'created_at',
                  'updated_at',)
...
class Shifr_va_passportSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'title',  'file', 'date', 'status', 'order', 'created_at', 'updated_at',)


class Dissertatsiya_va_avtorefSerializer(serializers.ModelSerializer):
    class Meta:
        model = Dissertatsiya_va_avtoref
        fields = ('id', 'title',  'content', 'status', 'order', 'created_at', 'updated_at',)


class Dissertatsiya_fayllarSerializer(serializers.ModelSerializer):
    class Meta:
        model = Dissertatsiya_fayllar
        fields = ('id', 'title',  'content', 'file', 'base_file', 'status', 'order', 'created_at', 'updated_at',)
...
class Yosh_olimlar_azolariSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'title',  'position', 'degree', 'contact', 'email', 'file', 'status', 'order', 'created_at',
                  'updated_at',)
...
class MaruzalarSerializer(serializers.ModelSerializer):
    class Meta:
        model = Maruzalar
        fields = ('id', 'title',  'content', 'subcontent', 'file', 'data', 'status', 'order', 'created_at',
                  'updated_at',)
