...
urlpatterns = [
    ...
    path('ilmiy-kengash-majlis/', Ilmiy_kengash_majlisListView.as_view(), name='ilmiy_kengash_majlis-list'),
    path('ilmiy-kengash-majlis/<int:pk>/', ilmiy_kengash_majlisdetail, name='ilmiy_kengash_majlis-detail'),
