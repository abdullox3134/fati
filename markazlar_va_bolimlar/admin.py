...
class Azolarsubadmin(admin.TabularInline):
    model = Azolarsub
    fields = ['title_uz', 'title_ru', 'title_en', 'link']
...
class AzolarAdmin(admin.ModelAdmin):
    ...
    fields = ('title_uz', 'title_ru', 'title_en', 'content_uz', 'content_ru', 'content_en', 'birth', 'sphere',
              'position', 'academic_degree', 'email', 'file', 'center_id', 'status', 'order',)
...
class Rasmsub(admin.ModelAdmin):
    list_display = ('title', 'status', 'created_at', 'updated_at', 'order',)
    fields = ['title_uz', 'title_ru', 'title_en', 'content_uz', 'content_ru', 'content_en', 'image', 'center_id',
              'file', 'status', 'order', ]
